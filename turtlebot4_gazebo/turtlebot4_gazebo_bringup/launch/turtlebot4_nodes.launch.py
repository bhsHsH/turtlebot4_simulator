...
def generate_launch_description():
    ...
    # turtlebot4_gazebo_hmi_node = Node(
    #     package='turtlebot4_gazebo_toolbox',
    #     name='turtlebot4_gazebo_hmi_node',
    #     executable='turtlebot4_gazebo_hmi_node',
    #     output='screen',
    ...
    # ld.add_action(turtlebot4_gazebo_hmi_node)
    return ld
